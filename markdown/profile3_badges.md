...
링크: [shields.io](https://shields.io)

## 사용법

아래의 코드를 순서대로 전부 붙이면 뱃지가 완성됨

```markdown
![aaa](https://img.shields.io/badge/<LABEL>-<MESSAGE>-<COLOR>?style=plastic&logo=Python&logoColor=ffffff&labelColor=abcdef)
기본 + style 추가 + logo 추가
```
...
![example](https://img.shields.io/badge/LABEL-MESSAGE-000000)

color 의 예시는 [shield.io](https://shields.io) 사이트에서 확인 가능
...
![example](https://img.shields.io/badge/style-plastic-000000?style=plastic)

![example](https://img.shields.io/badge/style-flat-000000?style=flat)

![example](https://img.shields.io/badge/style-flat--square-000000?style=flat-square)

![example](https://img.shields.io/badge/style-for--the--badge-000000?style=for-the-badge)

![example](https://img.shields.io/badge/style-social-000000?style=social)

### logo 추가 (왼쪽)

사용가능 로고 명칭은 [simple icon](https://simpleicons.org/?q=markdown)에서 확인 가능

```markdown
&logo=Python&logoColor=ffffff
```

![example](https://img.shields.io/badge/LABEL-MESSAGE-000000?style=platic&logo=Python&logoColor=ffffff)
...
![example](https://img.shields.io/badge/LABEL-MESSAGE-000000?style=platic&logo=Python&logoColor=ffffff&labelColor=abcdef)
